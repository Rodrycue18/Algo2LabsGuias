...
public class AgendaTests {
    ...
    void crearRecordatorio() {
        ...
        // Evitar aliasing.
        f.incrementarDia();
        Fecha f2 = recordatorio.fecha(); //Copio en f2 el objeto Fecha de mi instancia recordatorio
        f2.incrementarDia(); //Al incrementar aqui estoy incrementando a mi variable f2 y a la fecha de mi instancia recordatorio
